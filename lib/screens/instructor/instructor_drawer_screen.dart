...
class InstructorDrawerScreen extends StatefulWidget {
  ...
  const InstructorDrawerScreen({Key key, this.controller,this.textDirection}) : super(key: key);
...
class _InstructorDrawerScreenState extends DrawerStateMaster<InstructorDrawerScreen> {
  ...
  Widget get courses=> InstructorWidgets.getInstructorCoursesInDrawer(widget.textDirection);
...
//                 child: InstructorWidgets.getInstructorCoursesInDrawer(textDirection),
//               ),
//               Widgets.getContainerWithOnOnTap(
//                 Icon(
